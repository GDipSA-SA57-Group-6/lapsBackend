...
public class AdminController {
    ...
    //LF done, redirecting to Create Employee handled by front end
    ...
    */
    //LF: REPLACE WITH BELOW
    
    //LF done. Employee also deleted
    ...
    //two {}, LF dont know how to handle. The ModifyUserRole seem not saving the new change
    /*
    ...
    */
    ...
    //LF change to simpler version. LF done
    ...
    public ResponseEntity<User> modifyUserRoleById(@PathVariable("id") int id, @RequestBody User inUser) {
        ...
        if (user != null) {
            ...
            if (inUser.getName() != null) { //disable at frontend
                user.setName(inUser.getName());
            }
            if (inUser.getUserType() != null) {
                user.setUserType(inUser.getUserType());
            }
            if (inUser.getPassword() != null) { //disable at frontend
                user.setPassword(inUser.getPassword());
            }
            
            // Save the updated user by using CreateUser, samre result
...
//    }
     ...
     * @return
     */
    //LF: Not doing this cos done above
